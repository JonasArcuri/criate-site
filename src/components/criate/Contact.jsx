...
const Contact = () => {
  ...
  const contactDetails = [
    { icon: <Mail size={20} className="text-primary" />, text: ' Lucas@influencehub360.com', href: 'Lucas@influencehub360.com' },
    { icon: <Phone size={20} className="text-primary" />, text: '+55 11 98525-5719', href: 'tel:+55 11 98525-5719' },
